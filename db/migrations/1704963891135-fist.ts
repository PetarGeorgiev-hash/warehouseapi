...
export class Fist1704963891135 implements MigrationInterface {
    name = 'Fist1704963891135'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."warehouse_type_enum" AS ENUM('liquid', 'non-liquid')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum" AS ENUM('owner', 'operator', 'viewer')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."product_role_enum" AS ENUM('liquid', 'non-liquid')`);
        ...
        await queryRunner.query(`CREATE TABLE "client" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "uic" character varying NOT NULL, "client_name" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_96da49381769303a6515a8785c7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."transfer_transfer_type_enum" AS ENUM('buy-in', 'transfer', 'sell')`);
        await queryRunner.query(`CREATE TABLE "transfer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "transfer_type" "public"."transfer_transfer_type_enum" NOT NULL DEFAULT 'buy-in', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP NOT NULL DEFAULT now(), "consumer_id" uuid, CONSTRAINT "REL_4215bd41f32fdeb9fcb39ca087" UNIQUE ("consumer_id"), CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "transfer_details" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "total_price" integer NOT NULL, "transfer_id" uuid, "product_id" uuid, "warehouse_id" uuid, CONSTRAINT "REL_23f2d57f4e8cb45010ee509257" UNIQUE ("transfer_id"), CONSTRAINT "REL_3bc2fcdbabc58c69303cdc8d0d" UNIQUE ("product_id"), CONSTRAINT "REL_55cb0f48808a0508d11f63f96d" UNIQUE ("warehouse_id"), CONSTRAINT "PK_a5d0ac640b05fac227ad4b9a42b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "invoice" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "number" integer NOT NULL, "transfer_id" uuid, CONSTRAINT "PK_15d25c200d9bcd8a33f698daf18" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."transfer_transfer_type_enum"`);
        await queryRunner.query(`DROP TABLE "client"`);
        await queryRunner.query(`DROP TABLE "product"`);
        await queryRunner.query(`DROP TYPE "public"."product_role_enum"`);
